...
final class LetterListCard extends Composite<Card> {
    ...
    LetterListCard(LetterListItemModel itemModel) {
        ...
        Signal.effect(this, () -> content.setTitle(itemModel.subject().get()));
        Signal.effect(this, () -> content.setSubtitle(DateTimeUtil.formatShort(requireNonNull(itemModel.lastUpdated().get()))));
